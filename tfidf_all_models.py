# -*- coding: utf-8 -*-
"""TFIDF_All_models.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1-SMYQE4DjSmMLUSR6xITW4KE2SxhRowV
"""
...
Tfidf_vect.fit(Corpus['texts'])
Train_X_Tfidf = Tfidf_vect.transform(Train_X)
Test_X_Tfidf = Tfidf_vect.transform(Test_X)

Tfidf_vect = TfidfVectorizer(max_features=1000)
Tfidf_vect.fit(sep_test['texts'])

Val_X_Tfidf = Tfidf_vect.transform(sep_test['texts'])
...
val_pred = SVM.predict(Val_X_Tfidf)
# Use accuracy_score function to get the accuracy
...
val_pred = logreg.predict(Val_X_Tfidf)
...
# val prediction
val_pred = clf.predict(Val_X_Tfidf)
...
val_pred = classifier.predict(Val_X_Tfidf)
...
val_pred = rf.predict(Val_X_Tfidf)
